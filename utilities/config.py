...
PERSON_APPROACH_CONFIG = {
    ...
    'SLOWDOWN_AREA': 32000,     # start slowing down when box area reaches this threshold
...
LID_CONFIG = {
    ...
    'CLOSED_POSITION_RIGHT': 2000, # PWM microseconds for closed position (mirrored — right hinge mounted opposite)
    'OPEN_POSITION_RIGHT': 1000, # PWM microseconds for open position (mirrored — right hinge mounted opposite)
