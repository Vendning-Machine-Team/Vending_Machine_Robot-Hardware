...
PERSON_APPROACH_CONFIG = {
    ...
    'STOP_AREA': 52000,         # stop when person's box area reaches this threshold
    'DEADBAND': 92,             # horizontal pixel deadband around frame center
    'INTENSITY': 5,             # default motor intensity during approach
    'SLOWDOWN_AREA': 42000,     # start slowing down when box area reaches this threshold
...
LID_LOCK_CONFIG = {
    ...
    'LOCKED_POSITION': 2000, # PWM microseconds for locked position
